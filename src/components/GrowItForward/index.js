            ...
            <div className="aboutDivOverlay">
                ...
                <MDBRow><MDBCol>
                    <div className="textWrap">
                        ...
                        <img className="tiledImgs" src="https://i.imgur.com/G2Hm1VZ.jpg"></img>

                    </div>
                    <hr></hr>
                    <h4 className="aboutTextBottom">
                        <br></br>Grow it Forward</h4><p className="aboutTextBlurb"> is a network of micro farms in Orange County where volunteers from congregations and communities work side-by-side with paid student farmers under the guidance of a Grow Orlando farm coordinator. Grow Orlando hires youth from underserved communities who gain work experience, financial literacy and life skills while cultivating their own seeds of potential.</p>
                        <br></br>
                        <br></br>
                        <h4 className="aboutTextBottom"><MDBIcon icon="caret-right" /> Vision</h4>
                        <p className="aboutTextBlurb">To eradicate food disparity in low wealth and under resourced communities</p>
                        <br></br>
                        <br></br>
                        <h4 className="aboutTextBottom"><MDBIcon icon="caret-right" /> Mission</h4>
                        <p className="aboutTextBlurb">To advance economic and food sovereignty through a self-sustaining micro farm network, utilizing available land of faith and community partners</p>
                        <br></br>
                        <br></br>
                        <h4 className="aboutTextBottom"><MDBIcon icon="caret-right" /> Expansion</h4>
                        <p className="aboutTextBlurb">St. Luke’s Farm broke ground September 2020 as a pilot and model for the Grow it Forward network. Our 2021 plans include four new farm sites as Grow it Forward moves into Food Priority Areas in the West Orange County area.
                        Friends of the Farm: We are grateful to all for encouragement, marketing and funding the fruits of our labor:
                        No Kid Hungry, Dr. Phillips Rotary, Pammies Sammies, Edible Orlando, West Orange Observer, Spectrum News 13, and the Eagle Scout program</p>
                        <br></br>
                        <br></br>
                        <h4 className="aboutTextBottom"><MDBIcon icon="caret-right" /> Support our Growth</h4> 
                        <p className="aboutTextBlurb">Shop our Saturday market or donate to our cause at st.lukes.org/growitforward. Click the GIVE button; choose Restoring Hope on the drop-down menu; and add “farm” in the notes section.</p>
                        <br></br>
                        <br></br>
